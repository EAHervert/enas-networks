...
parser.add_argument('--model_file_0', default='model_0.pth', type=str)  # Model path to weights
parser.add_argument('--model_file_1', default='model_1.pth', type=str)  # Model path to weights
...
# Get the model paths
model_dhdn_0 = os.getcwd() + '/models/' + args.model_file_0
model_dhdn_1 = os.getcwd() + '/models/' + args.model_file_1
...
dhdn_0.load_state_dict(torch.load(model_dhdn_0, map_location=device_0))
dhdn_1.load_state_dict(torch.load(model_dhdn_1, map_location=device_1))
