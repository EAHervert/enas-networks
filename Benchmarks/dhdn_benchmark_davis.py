...
model_path0 = os.getcwd() + '/models/{date}_dhdn_davis_{noise}.pth'.format(date=d1, noise=str(args.Noise))
model_path1 = os.getcwd() + '/models/{date}_edhdn_davis_{noise}.pth'.format(date=d1, noise=str(args.Noise))
