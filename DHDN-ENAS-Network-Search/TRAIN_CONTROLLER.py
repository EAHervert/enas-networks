...
parser.add_argument('--controller_loss_min', type=float, default=-1)  # Loss tolerance for convergence (Controller)
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        if controller_dict['Loss'] < args.controller_loss_min:
            break
